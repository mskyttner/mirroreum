...
Running locally requires that you have support for running containers, for example using [Docker Community Edition](https://docs.docker.com/engine/install/). Depending on your base operating system, installation procedures differ but are well documented online.
...
This will download and start a container, representing an instance of the `mskyttner/mirroreum` Docker Image. 
